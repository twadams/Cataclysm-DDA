...
static void mx_roadblock( map &m, const tripoint &abs_sub )
{
    ...
    const auto spawn_turret = [&]( int x, int y ) {
        if( one_in( 3 ) ) {
            ...
            m.add_spawn( mon_turret, 1, { x, y, abs_sub.z } );
        }
    };
